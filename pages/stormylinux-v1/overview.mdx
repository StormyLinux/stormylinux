...
This configuration can still be used as a daily driver and primary configuration. It can be extended and shaped into anything you would like it to be.

> Note: Stormy Linux v1.0 has been archived and will no longer be maintained.
