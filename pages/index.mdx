...
If you love **Arch**, you're in luck... **Stormy Linux** is primarily based on **Arch**, it can easily be installed by following the **Arch** installation instructions [here](/installation/arch-install).

For those who prefer more stability and robustness, **Stormy Linux** is well suited for **Debian**. If you would like to install **Stormy Linux** on **Debian** instead, click [here](/installation/debian-install) to get started.
