...
These are the workspaces with no activity, these are the icons that are hidden by default, but they can also be set to "visible" if you would like to see all your workspaces. These icons will then have a "light-gray" color if they have no applications open.
