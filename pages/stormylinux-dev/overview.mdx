...
The rest of the workspaces are automatically hidden when empty. There are a total of 16 workspaces. The rest of the workspaces are meant for the applications below:
