...
> **Note**: The Developer and Professional Editions are both paid versions, click [here](/stormylinux/purchase) to get started with purchasing the right configuration files or installation ISOs that are perfect for your needs. If you would like to use Stormy Linux Kickstart(Free Version), click [here](/stormylinux-kickstart/overview).
